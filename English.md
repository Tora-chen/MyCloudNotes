...
vessel n. 船；容器；血管  
expand v. 扩张
> extend 扩充，扩展，使延长（涉及范围，时间，距离），如：
> 1. There are plans to extend the no-smoking area.现已有扩大无烟区的计划。
> 2. The show has been extended for another six weeks.展览会又延长了六周。
> 3. Our land extends as far as the river.我们的土地一直延伸到河边。  
>   
> Expand 扩大，增加，增强（尺码、数量或重要性）；或扩展，发展（业务）， 如：  
> 1. Student numbers are expanding rapidly.学生人数在迅速增加。
> 2. The waist expands to fit all sizes.腰围可松可紧适合任何尺码。
> 3. The interest rate's coming down. I'll be able to expand or stay in business. 利率正在降低，我可以扩大公司或者维持经营。

innocent adj. 清白的，无辜的，天真的，不谙世故的  
emerge v. 出现，浮现  
...
capable adj. 有能力的  
cap- : capture   
Usually we use able to describe current things someone can do, and capable to talk about someone’s future potential.  
...
[The truth about recycling](https://youtu.be/_EF4LXLxquM?si=yQc0UTl4oG4JvGah)
